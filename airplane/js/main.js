...
var swTime1 = 360;
var swTime2 = 540;
var animateTime = 20000;
var myfjW = 70;
var myfjH = 60;
var yidongFun = function(a){
      $(a).addClass("buji1");
      if($(a).find("span").length > 0) animateTime = 18000;
        ...
        if(a==2){ /*补给2*/
         ...
         if(a == 3){  /*补给3*/
            ...
            setTimeout(function(){
                    ...
                    selfplan.plansizeX = 100;
                    selfplan.plansizeY = 85;
            },20000)
            $("#buji3").stop();
            $("#buji3").hide();
            $("#buji3").addClass("cz");
...
if(document.addEventListener){
    ...
    $("#contine").bind("click",function(){
        ...
        contineFun("#buji1","yt",numCf + 33000);
        contineFun("#buji2","yt",numCf + 66000);
        contineFun("#buji3","yt",numCf + 99000);
    });
...
function start(){
    ...
    if(mark==20){
        ...
        //中飞机
        if(mark1%5==0){
            enemys.push(new enemy(6,5,250,46,60,5000,swTime1,random(1,4),"image/middle_fjbz.gif","image/enemy3_fly_1.png"));
        }
        //大飞机
        if(mark1==20){
            enemys.push(new enemy(12,10,200,110,164,3000,swTime2,1,"image/big_fjbz.gif","image/enemy2_fly_1.png"));
            mark1=0;
        }
       //小飞机
        else{
            enemys.push(new enemy(1,1,255,34,24,1000,swTime1,random(1,5),"image/small_fjbz.gif","image/enemy1_fly_1.png"));
        }
        mark=0;
    }
...
/*创建子弹*/
    if(mark%5==0){
        bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+zdLeft,parseInt(selfplan.imagenode.style.top)-10));
    }
...
function begin(){
  (function(){
    ...
    clickStart("#buji1","yt",numCf + 33000);
    clickStart("#buji2","yt",numCf + 66000);
    clickStart("#buji3","yt",numCf + 99000);
